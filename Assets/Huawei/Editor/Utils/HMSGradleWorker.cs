    ...
    public class HMSGradleWorker : HMSEditorSingleton<HMSGradleWorker>, IPreprocessBuildWithReport
    {
        ...
        public HMSGradleWorker()
        {
            gradleSettings = new Dictionary<string, string[]>()
            {
                ...
                { AdsToggleEditor.AdsKitEnabled, new string[]{ "com.huawei.hms:ads-lite:13.4.58.301", "com.huawei.hms:ads-consent:3.4.54.300", "com.huawei.hms:ads-identifier:3.4.39.302", "com.huawei.hms:ads-installreferrer:3.4.39.302" } },
